...
//change password
public class ChangePwdTea extends JFrame implements ActionListener{
	private String host;
	...
	public ChangePwdTea(String adminID){
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource()==jbArray[0])
		{
			...
			try
			{
				String sql="update user_admin set PWD='"+newPwd+"' where adminID='"+adminID+"'"+
						   " and PWD='"+oldPwd+"'";
